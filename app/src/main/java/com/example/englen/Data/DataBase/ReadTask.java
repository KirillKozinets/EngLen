...
import com.example.englen.Layouts.LearnNewWords;
...
public class ReadTask {
    ...
    public static String[] readTask(DataBaseHelper helper, int item, String type, int max, Boolean isNew) throws Exception {
        ...
        Cursor cursor = mDb.rawQuery("SELECT * FROM TaskAnswersList WHERE Type = type ", null); // Читаем из базы данных определенные записи
